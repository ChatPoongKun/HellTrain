(function(triggerId, action, ...)
    ...
    local SUPPORTED_VIEWS = {
        ...
        freeTrainingView = {
            moduleName = "freeTrainingView",
            action = "validate",
            errorCode = "free_training_view_invalid",
            errorMessage = "freeTrainingView 스키마 검증에 실패했습니다.",
            validatorMessage = "freeTrainingView.validate 검증을 통과하지 못했습니다.",
        },
