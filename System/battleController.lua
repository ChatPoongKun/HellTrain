(function(triggerId, action, ...)
    ...
    local function prepareAftermathSkip(expectedBattleId, expectedViewTurnId)
    ...
    elseif action == "commitOutput" then
        return commitOutput()
    elseif action == "prepareAftermathSkip" then
