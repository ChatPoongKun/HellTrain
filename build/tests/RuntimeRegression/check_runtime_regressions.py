...
checks = [
    ...
    *[(Path(args[0]).name, [sys.executable, *args]) for args in [
        ...
        [HERE / 'check_character_load_error_popup.py'],
        [HERE / 'check_character_load_error_progression_view.py'],
        [HERE / 'check_character_load_error_view.py'],
        [HERE / 'check_character_profile_load_error.py'],
        [HERE / 'check_character_switch.py'],
        [HERE / 'check_character_context_lore.py'],
        [HERE / 'check_free_training.py'],
        [HERE / 'check_free_training_host_flow.py'],
        [HERE / 'check_free_training_summary.py'],
...
if not fast:
    checks += [(Path(args[0]).name, [sys.executable, *args]) for args in [
        ...
        [HERE / 'check_character_load_error_popup.py', 'jit'],
        [HERE / 'check_character_load_error_progression_view.py', 'jit'],
        [HERE / 'check_character_load_error_view.py', 'jit'],
        [HERE / 'check_character_profile_load_error.py', 'jit'],
        [HERE / 'check_character_switch.py', 'jit'],
        [HERE / 'check_character_context_lore.py', 'jit'],
        [HERE / 'check_free_training.py', 'jit'],
        [HERE / 'check_free_training_host_flow.py', 'jit'],
        [HERE / 'check_free_training_summary.py', 'jit'],
